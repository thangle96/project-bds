...
$Project = new Project();
$list = $Project->Project_admin_trash();
?>
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a class="btn btn-sm btn-success" href="index.php?option=Project">
            ...
            <table id = "myTable" class="table table-triped table-bordered table-hover">
                ...
                <?php foreach($list as $row) : ?>
                    <tr>
                        ...
                        href="index.php?option=Project&cat=retrash&id=<?php echo $row['id']; ?>"><i class="fas fa-trash-restore"></i></a>
                        <a class="btn btn-sm btn-danger" 
                        href="index.php?option=Project&cat=delete&id=<?php echo $row['id']; ?>"><i class="fas fa-trash"></i></a>
                        </td>
